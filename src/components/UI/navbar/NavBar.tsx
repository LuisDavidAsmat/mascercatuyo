...
import { categories } from "../../pages/PublishServiceOffer/ServicesData";
...
const NavBar = () =>  
{
  ...
  const buttons: ButtonNav[] = [
    ...
    },
    {
      label: "Quiénes somos",
      icon: (
        <svg  className=" h-6 w-6 fill-current " viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
Si buscas un servicio o quieres ofrecer tu talento, estás en el lugar indicado. ¡Conectemos juntos! 🚀</p>
    ...
    },
    {
      label: "Soporte",
      icon: (
        <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      extraIcon: (
        <svg className="mt-0.5 h-5 w-5 stroke-white stroke-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
