...
{ 
  ...
  return (
    <div className="bg-white">
      <HomeHeader />
      <main className='bg-black px-4 sm:px-16 gradient-background'>
        <NavBar />
        ...
        <figure className='w-3/4 sm:w-2/4 mx-auto mt-16'>
          <img src="./img/hero-img-nobg.png" alt="" className='w-full h-full'/>
        </figure>

        <figure className='w-4/4 sm:w-2/4 mx-auto mt-20'>
          <img src="./img/hero-subtitle-img.png" alt="" className='w-full h-full'/>
        </figure>


        <section className='mt-24 flex flex-col justify-center gap-8'>
          <Link to={"servicio-solicitar"} className="px-16 sm:px-0 sm:w-3/12 mx-auto py-2 rounded-xl uppercase text-black text-center bg-orange-100 border border-emerald-950
            dark:text-white">
            Solicitar servicio
          </Link>

          <Link to={"servicio-ofrecer"} className="px-20 sm:w-4/12 mx-auto sm:px-24 py-2 rounded-xl uppercase text-black  bg-orange-100 border border-emerald-950
            dark:text-white">
            Ofrecer servicio
          </Link>
        ...
        <section className='mt-14 sm:px-24 py-12'>
