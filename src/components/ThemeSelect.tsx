...
{
    displayType?: "icons" | "toggle" | "select";
}

const ThemeSelect: React.FC<ThemeSelectProps> = ({ displayType = "icons" }) => 
{
            ...
            >
              {isDarkMode ? (
                <svg
                  ...
                  className="h-6 w-6 text-text-color stroke-2 opacity-100 transition-opacity duration-500 ease-in-out"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 text-gray-700 stroke-2 opacity-100 transition-opacity duration-500 ease-in-out"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
